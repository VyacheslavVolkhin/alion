document.addEventListener("DOMContentLoaded", function() {
	...
	let wrapContent = document.querySelector(".wrap.header-fixed");
	if (wrapContent) {
		window.addEventListener("scroll", function () {
		  const windowTop = window.pageYOffset;
		  if (windowTop > 0) {
			document.querySelector(".wrap").classList.add("header-fixed-bg");
		   } else {
			document.querySelector(".wrap").classList.remove("header-fixed-bg");
		   }
	   });
	}
